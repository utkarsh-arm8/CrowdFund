  ...
  "node_modules/cipher-base/index.js"(exports2, module2) {
    ...
    CipherBase.prototype.update = function(data, inputEnc, outputEnc) {
      ...
      if (data instanceof Buffer2) {
        ...
        bufferData = Buffer2.from(data, inputEnc);
      } else if (useArrayBuffer && ArrayBuffer.isView(data)) {
        bufferData = Buffer2.from(data.buffer, data.byteOffset, data.byteLength);
      } else if (useUint8Array && data instanceof Uint8Array) {
        bufferData = Buffer2.from(data);
      } else if (Buffer2.isBuffer(data) && data.constructor && data.constructor.isBuffer && data.constructor.isBuffer(data)) {
        bufferData = Buffer2.from(data);
      } else {
...
//# sourceMappingURL=chunk-NPKO3TR3.js.map
