...
var import_dist13, import_dist14, import_dist15, extendStatics, __assign;
...
var import_dist88, import_dist89, import_dist90, IEvents;
...
function unfetch_module_default(e2, n3) {
  return n3 = n3 || {}, new Promise(function(t, r2) {
    ...
    for (var l3 in s2.open(n3.method || "get", e2, true), s2.onload = function() {
...
var O = async (i2, t, e2) => {
  ...
  await t.setItem(n3, y), e2(t), j(i2, m2);
};
var j = async (i2, t) => {
...
tslib/tslib.es6.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-CGXI2HBF.js.map
