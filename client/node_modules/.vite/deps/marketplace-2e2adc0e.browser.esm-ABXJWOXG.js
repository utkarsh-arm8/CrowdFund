...
var MarketplaceDirect = class {
  ...
  async isStillValidListing(listing, quantity) {
    ...
    const ERC165Abi = (await import("./IERC165-WCDML6RN.js")).default;
    const erc165 = new Contract(listing.assetContractAddress, ERC165Abi, provider);
    const isERC721 = await erc165.supportsInterface(InterfaceId_IERC721);
    const isERC1155 = await erc165.supportsInterface(InterfaceId_IERC1155);
    if (isERC721) {
      const ERC721Abi = (await import("./IERC721-P63L2A4L.js")).default;
      ...
      const ERC1155Abi = (await import("./IERC1155-RN36JXRL.js")).default;
...
//# sourceMappingURL=marketplace-2e2adc0e.browser.esm-ABXJWOXG.js.map
