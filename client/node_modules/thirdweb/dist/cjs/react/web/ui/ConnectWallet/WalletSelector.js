...
const WalletSelectorInner = (props) => {
    ...
    const connectAWallet = ((0, jsx_runtime_1.jsx)(WalletTypeRowButton_js_1.WalletTypeRowButton, { client: props.client, icon: OutlineWalletIcon_js_1.OutlineWalletIcon, onClick: () => {
