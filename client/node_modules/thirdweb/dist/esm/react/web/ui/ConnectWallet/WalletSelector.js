...
const WalletSelectorInner = (props) => {
    ...
    const connectAWallet = (_jsx(WalletTypeRowButton, { client: props.client, icon: OutlineWalletIcon, onClick: () => {
    ...
    const tos = props.meta.requireApproval ||
        ...
        props.meta.privacyPolicyUrl ? (_jsx(TOS, { termsOfServiceUrl: props.meta.termsOfServiceUrl, privacyPolicyUrl: props.meta.privacyPolicyUrl, locale: props.connectLocale.agreement, requireApproval: props.meta.requireApproval, isApproved: approvedTOS, onApprove: () => setApprovedTOS(!approvedTOS) })) : undefined;
    let topSection;
    let bottomSection;
    // wide modal
    if (!isCompact) {
    ...
    return (_jsxs(Container, { scrollY: true, flex: "column", animate: "fadein", fullHeight: true, style: {
            maxHeight: props.size === "compact" ? compactModalMaxHeight : undefined,
                    ...
                    : {
                        paddingTop: "2px",
                    }, children: [!showHeader && isWalletGroupExpanded && (_jsx(Container, { flex: "row", center: "y", style: {
                            padding: spacing.sm,
                            paddingTop: 0,
