...
export function ConnectModal(props) {
    ...
    switch (modalState.screen) {
        ...
        case "external_wallets": {
            content = (_jsxs(_Fragment, { children: [_jsx(Header, { theme: theme, onClose: props.onClose, containerType: containerType, onBack: () => setModalState({ screen: "base" }), title: props.connectModal?.title || "Sign in" }), _jsx(Spacer, { size: "lg" }), _jsx(ExternalWalletsList, { theme: theme, externalWallets: externalWallets, client: client, connector: connector, containerType: containerType, showAllWalletsButton: props.showAllWallets !== false, onShowAllWallets: () => setModalState({ screen: "all_wallets" }) })] }));
            break;
        }
        case "all_wallets": {
            content = (_jsxs(_Fragment, { children: [_jsx(Header, { theme: theme, onClose: props.onClose, containerType: containerType, onBack: () => inAppWallet
                            ? setModalState({ screen: "external_wallets" })
                            : setModalState({ screen: "base" }), title: props.connectModal?.title || "Select Wallet" }), _jsx(Spacer, { size: "lg" }), _jsx(AllWalletsList, { theme: theme, externalWallets: externalWallets, client: client, connector: connector, containerType: containerType })] }));
            break;
        }
        case "connecting": {
            content = (_jsxs(_Fragment, { children: [_jsx(Header, { theme: theme, onClose: props.onClose, containerType: containerType, onBack: () => setModalState({ screen: "base" }), title: props.connectModal?.title || "Sign in" }), containerType === "modal" ? (_jsx(View, { style: { flex: 1 } })) : (_jsx(Spacer, { size: "lg" })), _jsx(WalletLoadingView, { theme: theme, wallet: modalState.wallet, client: client, authProvider: modalState.authMethod }), containerType === "modal" ? (_jsx(View, { style: { flex: 1 } })) : (_jsx(Spacer, { size: "md" }))] }));
            break;
        }
        case "passkey": {
        ...
        default: {
            content = (_jsxs(_Fragment, { children: [_jsx(Header, { theme: theme, onClose: props.onClose, containerType: containerType, title: props.connectModal?.title || "Sign in" }), inAppWallet ? (_jsxs(_Fragment, { children: [containerType === "modal" ? (_jsx(View, { style: { flex: 1 } })) : (_jsx(Spacer, { size: "lg" })), _jsxs(View, { style: {
                                    ...
                                    flex: 1,
                                }, children: _jsx(ExternalWalletsList, { theme: theme, externalWallets: externalWallets, client: client, connector: connector, containerType: containerType, showAllWalletsButton: props.showAllWallets !== false, onShowAllWallets: () => setModalState({ screen: "all_wallets" }) }) })] })) : null] }));
        }
    }
...
function WalletLoadingView({ theme, wallet, client, authProvider, }) {
    ...
    return (_jsxs(View, { style: {
            ...
            paddingVertical: spacing.xl,
                        ...
                        padding: spacing.sm,
                    }, children: _jsx(RNImage, { theme: theme, size: 80, data: getAuthProviderImage(authProvider), color: theme.colors.accentButtonBg }) })) : (_jsx(WalletImage, { theme: theme, size: 90, wallet: wallet, client: client })) }), _jsx(Spacer, { size: "xl" }), _jsx(ThemedText, { theme: theme, type: "subtitle", children: authProvider
...
function SignInView({ theme, siweAuth, client, onSignIn, onError, onDisconnect, }) {
    ...
    return (wallet && (_jsxs(View, { style: {
            ...
            justifyContent: "center",
            padding: spacing.xl,
        }, children: [_jsx(WalletLoadingThumbnail, { theme: theme, imageSize: 100, animate: isSigningIn, children: _jsx(WalletImage, { theme: theme, size: 90, wallet: wallet, client: client }) }), _jsx(Spacer, { size: "xl" }), _jsx(ThemedText, { theme: theme, type: "subtitle", children: "Complete sign in" }), _jsx(Spacer, { size: "xs" }), _jsxs(ThemedText, { theme: theme, type: "subtext", children: ["Sign login request in ", walletInfo.data?.name, " to continue"] }), _jsx(Spacer, { size: "xl" }), _jsx(ThemedButton, { theme: theme, variant: "accent", disabled: isSigningIn, style: { width: "100%" }, onPress: async () => {
                    try {
                        await siweAuth.doLogin();
                        onSignIn();
                    }
