...
export declare const ROUTE_GET_USER_SHARES: string;
export declare const ROUTE_VERIFY_THIRDWEB_CLIENT_ID: string;
export declare const ROUTE_AUTH_JWT_CALLBACK: string;
export declare const ROUTE_AUTH_ENDPOINT_CALLBACK: string;
export declare const ROUTE_AUTH_COGNITO_ID_TOKEN_V1: string;
export declare const ROUTE_AUTH_COGNITO_ID_TOKEN_V2: string;
